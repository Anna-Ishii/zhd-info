                                ...
                                <th class="column{{ $columnNum }}">
                                    <div class="sort-wrap">
                                        <div class="sort-wrap__item">
                                            ...
                                            <a href="{{ route('admin.message.publish.edit', ['message_id' => $m->id]) }}">{{ $m->title }}</a>
                                        </div>
                                        ...
                                        @isset($v_org1[0]->count)
                                            <td class="{{ $columnNum }}" data-message="{{ $messages[$key]->id }}" data-org-type="Org1" data-org-id="{{ $organization1->id }}" nowrap>
                                                <div class="view_rate progress-inline" data-view-type="orgs">
                                                    ...
                                                    <span class="pill">{{ $v_org1[0]->view_rate }}%
                                                </div>
                    </div>
                    </td>
                @else
                                ...
                                <div class="progress-inline">
                                    ...
                                    <span class="pill">
                                        @if (isset($viewrates[$organization . '_readed_sum'][$v_o->id]) && ($viewrates[$organization . '_sum'][$v_o->id] ?? 0) > 0)
                                            @php
                                                $viewrate = 0;
                                                $viewrate = number_format(($viewrates[$organization . '_readed_sum'][$v_o->id] / $viewrates[$organization . '_sum'][$v_o->id]) * 100, 1);
                                            @endphp
                                            <div>{{ $viewrate }}%</div>
                                        @else
                                            <div>0.0%</div>
