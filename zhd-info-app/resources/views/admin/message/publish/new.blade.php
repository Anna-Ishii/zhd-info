...
@section('content')
            ...
            <div class="form-group" hidden>
                ...
                <div class="col-lg-10 checkArea">
                    ...
                    @foreach ($target_roll_list as $target_roll)
                        <label class="mr16">
                            <input type="checkbox" name="target_roll[]" value="{{ $target_roll->id }}"
                                class="checkCommon mr8" checked>
                            {{ $target_roll->name }}
                        </label>
                    @endforeach
                </div>
    ...
    @include('common.admin.message-new-store-modal', ['organization_list' => $organization_list, 'all_shop_list' => $all_shop_list,])
    {{-- @include('common.admin.message-new-store-import-modal') --}}
