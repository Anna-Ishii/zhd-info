...
@section('content')
    ...
    <script src="{{ asset('/js/admin/message/publish/edit.js') }}?date=20240902" defer></script>
    <script src="{{ asset('/js/admin/message/publish/edit_store.js') }}?date=20240907" defer></script>
@endsection
